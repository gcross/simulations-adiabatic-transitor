-- @+leo-ver=4-thin
-- @+node:gcross.20091201234821.1655:@thin Database.hs
-- @@language Haskell

-- @<< Language extensions >>
-- @+node:gcross.20091201234821.1656:<< Language extensions >>
...
-- @+node:gcross.20091201234821.1657:<< Import needed modules >>
...
-- @+others
-- @+node:gcross.20091201234821.1660:Enumerators
-- @+node:gcross.20091201234821.1661:getX
...
-- @-node:gcross.20091201234821.1661:getX
-- @+node:gcross.20091201234821.1662:fetchX
...
-- @-node:gcross.20091201234821.1662:fetchX
-- @-node:gcross.20091201234821.1660:Enumerators
-- @+node:gcross.20091201234821.1677:Functions
-- @+node:gcross.20091201234821.1664:makeConnection
